...
<head>
    ...
    <style>
        ...
        .header { overflow: hidden; margin-bottom: 20px; border-bottom: 2px solid #6a1b24; padding-bottom: 15px; }
        .logo { float: left; width: 50%; }
        .company { float: right; width: 50%; text-align: right; }
        ...
        .info-grid { overflow: hidden; margin-bottom: 30px; }
        .info-box { float: left; width: 48%; }
        .info-box + .info-box { float: right; }
        ...
        .totals { overflow: hidden; margin-bottom: 50px; }
        .totals-table { float: right; width: 350px; border-collapse: collapse; }
