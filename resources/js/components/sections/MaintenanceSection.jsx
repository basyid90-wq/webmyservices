...
export default function MaintenanceSection() {
  ...
  return (
    <section id="maintenance" className="py-24 lg:py-32 bg-slate-900/30">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Website Maintenance Plans</h2>
        ...
        <div className="mb-12">
          <h3 className="text-lg font-semibold text-white mb-6 text-center">Everything Included in Your Plan</h3>
